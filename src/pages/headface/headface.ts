...
import {
  NavController, NavParams, ModalController, LoadingController, ActionSheetController, Platform,
  ToastController, ViewController, normalizeURL
} from 'ionic-angular';
import { Storage } from '@ionic/storage';
import { BaseUI } from '../../common/baseui';
import { RestProvider } from '../../providers/rest/rest';
//导入四个外部加载进来的组件，具体的安装方法在09-01章节
